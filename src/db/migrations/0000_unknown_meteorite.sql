...
--> statement-breakpoint
CREATE TABLE "sauce_bread_recommendations" (
	"id" serial PRIMARY KEY NOT NULL,
	"sauce_id" integer,
	"bread_id" integer,
	"compatibility_score" integer DEFAULT 50 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "sauce_bread_unique" UNIQUE("sauce_id","bread_id")
);
--> statement-breakpoint
CREATE TABLE "sauces" (
	"id" integer PRIMARY KEY NOT NULL,
...
ALTER TABLE "sauce_bread_recommendations" ADD CONSTRAINT "sauce_bread_recommendations_sauce_id_sauces_id_fk" FOREIGN KEY ("sauce_id") REFERENCES "public"."sauces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sauce_bread_recommendations" ADD CONSTRAINT "sauce_bread_recommendations_bread_id_breads_id_fk" FOREIGN KEY ("bread_id") REFERENCES "public"."breads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "bundle_name_idx" ON "bundles" USING btree ("name");--> statement-breakpoint
